    ...
    <div>
        <div class="row justify-content-center ">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{ route('penyakit.edit', $penyakit->id) }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-12 fw-bold">Judul</label>
                                <div class="col-md-12">
                                    <input type="text" value="{{ $penyakit->title }}" name="title"
                                        class="form-control form-control-line" required>
                                </div>
                            </div>

                            @foreach ($penyakit->categories as $index => $oldCategory)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="{{ $penyakit->description }}" name="description"
                                        class="form-control form-control-line" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-12 fw-bold">Penyebab Penyakit</label>
                                <div class="col-md-12">
                                    <input type="text" value="{{ $penyakit->penyebab_penyakit }}"
                                        name="penyebab_penyakit" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line shadow-sm rounded-3 " name="pengendalian">{{ $penyakit->pengendalian }}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="example-email" class="col-md-12 fw-bold">Penularan Penyakit</label>
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line shadow-sm rounded-3 " name="penularan_penyakit">{{ $penyakit->penularan_penyakit }}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="example-email" class="col-md-12 fw-bold">Waktu Terjadi Serangan</label>
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line shadow-sm rounded-3 " name="waktu_terjadi_serangan">{{ $penyakit->waktu_terjadi_serangan }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <div class="col-md-6">
                                    <label class="col-md-12 fw-bold">Deskripsi Gambar Tanda Serangan *kosongkan jika tidak
                                        diubah</label>
