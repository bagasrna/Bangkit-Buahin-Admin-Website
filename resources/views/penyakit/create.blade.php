    ...
    <div>
        <div class="row justify-content-center ">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{ route('penyakit.create') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="penyebab_penyakit" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line shadow-sm rounded-3 " name="penularan_penyakit"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line shadow-sm rounded-3 " name="waktu_terjadi_serangan"></textarea>
                                </div>
                            </div>
