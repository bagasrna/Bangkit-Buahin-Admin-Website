    ...
    <div>
        <div class="row justify-content-center ">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{ route('gulma.edit', $gulma->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-12 fw-bold">Judul</label>
                                <div class="col-md-12">
                                    <input type="text" value="{{ $gulma->title }}" name="title" class="form-control form-control-line" required>
                                </div>
                            </div>

                            <div class="form-group d-flex justify-content-between">
                                <div class="col-md-6">
                                    <label class="col-md-12 fw-bold">Deskripsi Gambar *kosongkan jika tidak diubah</label>
