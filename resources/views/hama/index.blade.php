...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><i class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i>Hama</h4>
                    <h6 class="card-subtitle">
                        Data hama yang terdaftar di database
                    </h6>
                    <div class="d-flex">
                        <a href="{{ route('hama.create.page') }}" class="btn btn-primary float-right m-10"><i
                                class="mdi mdi-plus-circle-outline"></i> Tambah Hama</a>
                        <a href="{{ route('hama.category.index') }}" class="btn btn-primary float-right m-10"><i
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                ...
                text: 'Anda akan delete hama ini!',
                icon: 'warning',
